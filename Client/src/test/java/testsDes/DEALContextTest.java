...
public class DEALContextTest {
  ...
  void testTextFileCycle() throws IOException {
    ...
    String in = testDirectory + "/Schonhage_Strassen_multiplication_tests.cpp";
    String encOut = testDirectory + "/encryptedSSMTests";
    String decOut = testDirectory + "/decryptedSSMTests";
